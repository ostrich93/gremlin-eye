        ...
        <>
            <div className="modal__container">
                ...
                <Container fluid className="py-0 modal__content">
                    <Row id="played" className="pt-1 pb-2 mb-2 play-type-option fill-in" onClick={(e) => handleStatusChange(e, 0)}>
                    ...
                    <Row id="completed" className="pt-1 pb-2 mb-2 play-type-option fill-in" onClick={(e) => handleStatusChange(e, 1)}>
                        <Col className="col-12 my-auto">
                    ...
                    <Row id="retired" className="pt-1 pb-2 mb-2 play-type-option fill-in" onClick={(e) => handleStatusChange(e, 2)}>
                        <Col className="col-12 my-auto">
                    ...
                    <Row id="shelved" className="pt-1 pb-2 mb-2 play-type-option fill-in" onClick={(e) => handleStatusChange(e, 3)}>
                        <Col className="col-12 my-auto">
                    ...
                    <Row id="abandoned" className="pt-1 pb-2 mb-2 play-type-option fill-in" onClick={(e) => handleStatusChange(e, 4)}>
                        <Col className="col-12 my-auto">
