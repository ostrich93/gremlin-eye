...
namespace gremlin_eye.Server.Migrations
{
    ...
    [Migration("20250908183641_V5SmootherIgdbDependencies")]
    partial class V5SmootherIgdbDependencies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gremlin_eye.Server.Entity.GameCompany", b =>
                {
            ...
            modelBuilder.Entity("gremlin_eye.Server.Entity.GameGenre", b =>
                {
                    b.Property<long>("GameId")
                        .HasColumnType("bigint")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("gremlin_eye.Server.Entity.GamePlatform", b =>
                {
                    b.Property<long>("GameId")
                        .HasColumnType("bigint")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("gremlin_eye.Server.Entity.GameSeries", b =>
                {
                    b.Property<long>("GameId")
                        .HasColumnType("bigint")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("gremlin_eye.Server.Entity.SeriesData", b =>
                {
                    ...
                    b.ToTable("series_data");
                });

            modelBuilder.Entity("gremlin_eye.Server.Entity.GameCompany", b =>
                {
                    b.HasOne("gremlin_eye.Server.Entity.CompanyData", "Company")
            ...
            modelBuilder.Entity("gremlin_eye.Server.Entity.GameGenre", b =>
                {
                    ...
                    b.HasOne("gremlin_eye.Server.Entity.GenreData", "Genre")
                        .WithMany("GameGenres")
            ...
            modelBuilder.Entity("gremlin_eye.Server.Entity.GameSeries", b =>
                {
                    ...
                    b.HasOne("gremlin_eye.Server.Entity.SeriesData", "Series")
                        .WithMany("GameSeries")
